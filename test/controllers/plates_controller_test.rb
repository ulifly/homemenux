...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference("Plate.count") do
      post plates_url, params: { plate: { ingredient_id: @plate.ingredient_id, name: @plate.name } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { ingredient_id: @plate.ingredient_id, name: @plate.name } }
